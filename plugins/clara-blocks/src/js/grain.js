// ─── WebGL film grain (green sections) ────────────────────────────────────
(function initGrainCanvases() {
  ...
  var fragmentShaderSource = [
    ...
    '    // Add time to uv to animate grain slightly, or keep static. Let\'s keep it fast for film feel.',
    '    float noise = random(uv * 2.0 + fract(u_time * 0.0001)); ',
    '    ',
    '    // Base color is transparent, grain is white with low opacity',
    '    vec3 color = vec3(noise);',
    '    // Extremely subtle alpha, as the blend mode is \'overlay\'',
